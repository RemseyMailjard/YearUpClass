function updateClock() {
    ...
    var panamaTime = new Date(now.getUTCFullYear(), now.getUTCMonth(), now.getUTCDate(), now.getUTCHours() - 5, now.getUTCMinutes(), now.getUTCSeconds());

    document.getElementById("phoenixTime").textContent = phoenixTime.toLocaleTimeString();
    document.getElementById("panamaTime").textContent = panamaTime.toLocaleTimeString();
